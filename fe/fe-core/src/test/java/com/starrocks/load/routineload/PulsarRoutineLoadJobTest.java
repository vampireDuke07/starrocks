...
public class PulsarRoutineLoadJobTest {
    ...
    private String pulsarPartitionString = "1,2,3";
    ...
    public void testFromCreateStmt(@Mocked GlobalStateMgr globalStateMgr,
        ...
        Deencapsulation.setField(createRoutineLoadStmt, "pulsarBrokerList", serverAddress);
        ...
        Assert.assertEquals(pulsarPartitionString, Joiner.on(",").join(kafkaPartitionResult));
    }
