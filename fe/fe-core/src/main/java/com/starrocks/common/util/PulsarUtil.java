...
public class PulsarUtil {
    ...
    public static Map<Integer, Long> getBeginningOffsets(String serverUrl, String topic,
                                                         ImmutableMap<String, String> properties,
                                                         List<Integer> partitions) throws UserException {
        return proxyApi.getBeginningOffsets(serverUrl, topic, properties, partitions);
    }

    public static List<PPulsarOffsetProxyResult> getBatchOffsets(List<PPulsarOffsetProxyRequest> requests) throws UserException {
    ...
    static class ProxyAPI {
        ...
        public Map<Integer, Long> getLatestOffsets(String serverUrl, String topic,
                                                   ImmutableMap<String, String> properties,
                                                   List<Integer> partitions) throws UserException {
            return getOffsets(serverUrl, topic, properties, partitions, true);
        }

        public Map<Integer, Long> getBeginningOffsets(String serverUrl, String topic,
                                                      ImmutableMap<String, String> properties,
                                                      List<Integer> partitions) throws UserException {
            return getOffsets(serverUrl, topic, properties, partitions, false);
        }

        public Map<Integer, Long> getOffsets(String serverUrl, String topic,
                                             ImmutableMap<String, String> properties,
            ...
            offsetRequest.pulsarInfo = genPPulsarLoadInfo(serverUrl, topic, properties);
        ...
        public List<PPulsarOffsetProxyResult> getBatchOffsets(List<PPulsarOffsetProxyRequest> requests) throws UserException {
            // create request
